...
class WPDCLoss(nn.Module):
    ...
    def __init__(self, opt_style='resample', resample_num=240):
        ...
        w = np.concatenate((self.model['shapePC'], self.model['expPC']), axis=1)
        ...
        self.w_shp_length = self.w_shp.shape[0] // 3
        keypoints = _load('./Data/keypoints_sim.npy')
